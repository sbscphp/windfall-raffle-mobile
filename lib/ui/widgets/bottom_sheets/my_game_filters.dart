...
class MyGameFilters extends ConsumerStatefulWidget {
  const MyGameFilters({super.key});

  @override
  ConsumerState<MyGameFilters> createState() => _MyGameFiltersState();
}

class _MyGameFiltersState extends ConsumerState<MyGameFilters> {
  ...
  void initState() {
    ...
    selectedCategoryOption = vm.filterOptions['filter_by_real'];
  ...
  Widget build(BuildContext context) {
    final vm = ref.watch(myGameFiltersViewModel);
    return Container(
                  ...
                  children: [
                    CustomButton(
                        ...
                        onPressed: () async{
                          ...
                          if(_startDate == null && _endDate == null && selectedCategoryOption == null){
                            showFlushBar(
                              context: context,
                              success: false,
  ...
  myGames({required BuildContext context, required MyGameFiltersVm vm}){
    return  Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
